...
@section('content')
    <div class="container">
        <form method="POST" action="/games/dlc/update" enctype="multipart/form-data">
            ...
            <label for="image"> {{ __('dlc.image') }}: ({{ __('dlc.imagereqs') }})</label>
            <br>
            ...
            <input name="description" class="form-control" type="text" value="{{ $dlc->description }}">
            <br>
