        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <Link :href="index.url()" class="text-white text-xl font-display font-bold hover:text-accent-400 transition-colors">
                ...
                <div v-else class="flex items-center space-x-4">
                    <Link :href="login.url()" class="text-gray-300 hover:text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-dark-800">
                        Login
                    </Link>
                </div>
            </div>
