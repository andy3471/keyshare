<template>
    <div class="bg-dark-800 rounded-lg border border-dark-700 p-8">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-white mb-2">Add New Key</h1>
            <p class="text-gray-400">Share a game key with the community</p>
        </div>
            ...
            <div class="bg-dark-700/50 rounded-lg p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div v-if="form.errors.platform_id" class="mt-2 text-sm text-red-400">
            ...
            <div class="bg-dark-700/50 rounded-lg p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        />
                        <p class="mt-2 text-xs text-gray-500">Enter the game key code</p>
                        <div v-if="form.errors.key" class="mt-2 text-sm text-red-400">
                            {{ form.errors.key }}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        />
                        <p class="mt-2 text-xs text-gray-500">Optional message to include with your shared key</p>
                        <div v-if="form.errors.message" class="mt-2 text-sm text-red-400">
                            {{ form.errors.message }}
                        </div>
                    </div>
                </div>
