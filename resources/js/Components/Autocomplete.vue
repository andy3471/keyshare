    ...
    <div class="relative" ref="containerRef">
        <div class="relative">
            ...
            <div v-if="loading" class="absolute right-3 top-1/2 transform -translate-y-1/2">
                <svg class="animate-spin h-5 w-5 text-accent-400" fill="none" viewBox="0 0 24 24">
        ...
        >
            ...
            >
                <div class="max-h-60 overflow-auto">
                    ...
                    >
                        <div class="font-medium">{{ result.name || result }}</div>
                    </div>
                </div>
            </div>
        </Transition>
        ...
        >
            ...
            >
                <p class="text-gray-400 text-sm text-center">No games found. Try a different search term.</p>
            </div>
        </Transition>
    </div>
</template>
