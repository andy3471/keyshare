<template>
    <div class="bg-dark-800 rounded-lg border border-dark-700 p-4 mb-6">
        <div class="flex flex-wrap items-center gap-4">
            <div class="flex-1 min-w-[200px]">
                ...
                <div class="relative" data-platform-dropdown>
                    ...
                    >
                        <span v-if="selectedPlatforms.length === 0" class="text-gray-500">All Platforms</span>
                        <span v-else class="text-white">{{ selectedPlatforms.length }} selected</span>
                        <svg
            ...
            <div v-if="selectedPlatforms.length > 0" class="flex items-center gap-2">
                <button
                    @click="clearFilters"
        ...
        <div v-if="selectedPlatforms.length > 0" class="mt-3 flex flex-wrap gap-2">
            <span
...
const applyFilters = () => {
    ...
    router.get(games.index.url(params), {}, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
