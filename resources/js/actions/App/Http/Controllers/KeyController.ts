...
* @see app/Http/Controllers/KeyController.php:89
...
* @see app/Http/Controllers/KeyController.php:29
* @route '/keys/create'
*/
...
* @see app/Http/Controllers/KeyController.php:46
* @route '/keys'
*/
...
* @see app/Http/Controllers/KeyController.php:77
* @route '/keys/{key}'
*/
