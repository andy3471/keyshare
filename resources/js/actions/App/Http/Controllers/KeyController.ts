...
* @see app/Http/Controllers/KeyController.php:82
* @route '/keys/claimed'
*/
...
* @see app/Http/Controllers/KeyController.php:95
* @route '/keys/shared'
*/
...
* @see app/Http/Controllers/KeyController.php:36
* @route '/keys'
*/
...
* @see app/Http/Controllers/KeyController.php:61
* @route '/keys/{key}'
*/
