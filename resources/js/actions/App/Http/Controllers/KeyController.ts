...
* @see app/Http/Controllers/KeyController.php:67
* @route '/keys/claim'
*/
...
* @see app/Http/Controllers/KeyController.php:79
* @route '/keys/claimed'
*/
...
* @see app/Http/Controllers/KeyController.php:91
* @route '/keys/shared'
*/
...
* @see app/Http/Controllers/KeyController.php:34
* @route '/keys'
*/
...
* @see app/Http/Controllers/KeyController.php:57
* @route '/keys/{key}'
*/
