...
* @see app/Http/Controllers/GroupController.php:81
* @route '/groups/{group}'
*/
...
* @see app/Http/Controllers/GroupController.php:101
...
* @see app/Http/Controllers/GroupController.php:113
* @route '/groups/{group}'
*/
...
* @see app/Http/Controllers/GroupController.php:128
* @route '/groups/{group}'
*/
...
* @see app/Http/Controllers/GroupController.php:142
...
* @see app/Http/Controllers/GroupController.php:196
...
* @see app/Http/Controllers/GroupController.php:224
...
* @see app/Http/Controllers/GroupController.php:209
* @route '/groups/switch'
*/
export const switchGroup = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: switchGroup.url(options),
    method: 'post',
})

switchGroup.definition = {
    methods: ["post"],
    url: '/groups/switch',
} satisfies RouteDefinition<["post"]>
...
switchGroup.url = (options?: RouteQueryOptions) => {
    return switchGroup.definition.url + queryParams(options)
}
...
* @see app/Http/Controllers/GroupController.php:162
* @route '/invite/{code}'
*/
export const joinViaInviteCode = (args: { code: string | number } | [code: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: joinViaInviteCode.url(args, options),
    method: 'get',
})

joinViaInviteCode.definition = {
    methods: ["get","head"],
    url: '/invite/{code}',
} satisfies RouteDefinition<["get","head"]>
...
joinViaInviteCode.url = (args: { code: string | number } | [code: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return joinViaInviteCode.definition.url
...
const GroupController = { index, create, store, show, edit, update, destroy, join, leave, removeMember, regenerateInviteCode, switchGroup, joinViaInviteCode }
