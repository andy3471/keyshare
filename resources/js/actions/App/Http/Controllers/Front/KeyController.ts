...
* @see app/Http/Controllers/Front/KeyController.php:25
* @route '/keys/create'
*/
...
* @see app/Http/Controllers/Front/KeyController.php:39
* @route '/keys'
*/
...
* @see app/Http/Controllers/Front/KeyController.php:105
* @route '/keys/{key}'
*/
...
* @see app/Http/Controllers/Front/KeyController.php:116
* @route '/keys/claim'
*/
...
* @see app/Http/Controllers/Front/KeyController.php:133
