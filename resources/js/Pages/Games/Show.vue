        ...
        <div class="max-w-7xl mx-auto px-4 py-6">
            ...
            <div v-if="parentGame" class="mb-6">
                <div class="bg-dark-800 rounded-lg border border-dark-700 p-4 flex items-center gap-4">
                    ...
                    <Link :href="parentGame.url" class="flex items-center gap-3 hover:opacity-80 transition-opacity">
                        ...
                        >
                            <svg class="w-6 h-6 text-accent-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col lg:flex-row gap-6 mb-8">
                ...
                <div class="flex-1 bg-dark-800 rounded-lg border border-dark-700 p-6 h-fit">
                    ...
                    <div v-if="igdb && igdb.aggregated_rating" class="mb-4 text-gray-300">
                    ...
                    <div v-if="game.description" class="text-gray-300 leading-relaxed">
            ...
            <div v-if="childGames && childGames.data && childGames.data.length > 0" class="mt-8">
            ...
            >
                <div class="relative max-w-7xl max-h-[90vh] mx-4 flex items-center" @click.stop>
                    <!-- Close Button -->
                    <button
                        @click="closeImageModal"
...
interface Props {
    ...
    childGames?: {
        data: Array<{ id: number; igdb_id: number; name: string; image?: string; url: string; hasKey: boolean; keyCount: number }>;
        current_page: number;
        last_page: number;
        per_page: number;
        total: number;
