<template>
    <AppLayout :title="user.name">
        ...
        <div class="max-w-7xl mx-auto px-4 py-6">
                    ...
                    <div class="flex-1">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                ...
                                <p v-if="user.bio" class="text-gray-300 text-lg leading-relaxed max-w-2xl">{{ user.bio }}</p>
            ...
            <div v-if="user.id === auth.user?.id" class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <Link
                ...
                >
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-300 mb-1 group-hover:text-white transition-colors">Claimed Keys</h3>
                            <p class="text-sm text-gray-500">View your claimed game keys</p>
                        </div>
                ...
                >
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-300 mb-1 group-hover:text-white transition-colors">Shared Keys</h3>
                            <p class="text-sm text-gray-500">View your shared game keys</p>
                        </div>
