        ...
        <div class="max-w-4xl mx-auto px-4 py-6">
            ...
            <div class="bg-dark-800 rounded-lg border border-dark-700 p-8">
                ...
                <form @submit.prevent="submit" enctype="multipart/form-data" class="space-y-6">
                    <!-- Error Display -->
                    <div v-if="Object.keys(form.errors).length > 0" class="bg-red-900/50 border border-red-700 rounded-lg p-4">
                        <div v-for="(error, field) in form.errors" :key="field" class="text-red-300 text-sm mb-1">
                    ...
                    <div class="bg-dark-700/50 rounded-lg p-6">
                        <h2 class="text-xl font-semibold text-white mb-4">Profile Image</h2>
                        <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                />
                                <p class="mt-2 text-xs text-gray-500">1:1 ratio required (square image). Max size: 2MB</p>
                                <div v-if="form.errors.image" class="mt-2 text-sm text-red-400">
                                    {{ form.errors.image }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-dark-700/50 rounded-lg p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div v-if="form.errors.bio" class="mt-1 text-sm text-red-400">
                                    {{ form.errors.bio }}
                                </div>
                            </div>
                        </div>
