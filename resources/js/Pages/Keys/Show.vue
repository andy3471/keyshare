        ...
        <div class="max-w-4xl mx-auto px-4 py-6">
            ...
            <div class="bg-dark-800 rounded-lg border border-dark-700 p-6">
                ...
                <div class="flex items-start space-x-4">
                    <Link :href="`/users/${keyData.createdUser?.id}`">
                        <img
                    ...
                    <div class="flex-1">
                        <h5 class="text-lg font-semibold text-white mb-2">
                            ...
                            <span
                                :class="[
                                    'badge ml-2',
                                    keyData.createdUser?.karma_colour === 'badge-danger' ? 'badge-danger' :
                                    keyData.createdUser?.karma_colour === 'badge-warning' ? 'badge-warning' :
                                    keyData.createdUser?.karma_colour === 'badge-info' ? 'badge-info' :
                                    'badge-success'
                                ]"
                            >
